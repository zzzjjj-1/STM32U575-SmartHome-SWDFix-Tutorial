# STM32U575-SmartHome-SWDFix-Tutorial
STM32U575智能家居项目SWD连接失败保姆级排查+全片擦除教程，解决No target found问题
...
![Keil-No-ST-LINK-detected](docs/images/1-keil-no-stlink.png)
![Keil-No-target-found](docs/images/2-keil-no-target.png)

### 2. CubeProgrammer 端报错
无论怎么调整参数，都无法连接芯片，日志持续报错：

![CubeProgrammer-connect-fail](docs/images/10-cube-connect-fail.png)

### 3. 命令行（CLI）擦除失败报错
尝试用 `STM32_Programmer_CLI.exe` 命令行擦除，同样连接失败：

![CLI-error](docs/images/11-cli-error.png)
...
![CubeProgrammer-update](docs/images/3-cube-update.png)
...
![Keil-Debug-setting](docs/images/4-keil-debug-tab.png)
![Keil-ST-Link-setting](docs/images/5-keil-stlink-setting.png)
...
![CubeProgrammer-erase](docs/images/7-cube-erase.png)
![CubeProgrammer-erase-success](docs/images/8-cube-erase-success.png)
...
![BOOT0-fix](docs/images/6-boot0-fix.png)
...
## 📄 许可证
本教程采用 [MIT License](LICENSE) 开源，可自由转载、修改，注明出处即可。
